...
public class Lesson10 : MonoBehaviour
{
  ...
  [SerializeField]
    private GameObject LessonEnAudioButton;
     ...
     public string[] Entext = { "Spring","Storm","Snow", "Winter", "Wind", "Cold", "Fall", "Hot", "Rain", "Summer"}; // ingilizce Textler
     public string[] Trtext = {"Bahar","Fırtına","Kar","Kış", "Rüzgar", "Soğuk", "Sonbahar", "Sıcak", "Yağmur", "Yaz"};  // Türkçe Textler
 ...
 { 
   if(ImageCount == images.Length-1) {
         SceneManager.LoadScene("HavaDurumuQuiz");
      }
