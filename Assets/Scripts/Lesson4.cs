...
public class Lesson4 : MonoBehaviour
{
  ...
  [SerializeField]
    private GameObject LessonEnAudioButton;
     ...
     public string[] Entext = { "excitement","Interest","Fear", "Happiness", "Hate", "Love", "Shame", "Anger", "Sadness", "Confused"}; // ingilizce Textler
     public string[] Trtext = {"Heyecan","İlgi","Korku","Mutlu", "Nefret", "Sevgi", "Utanç", "Öfke", "Üzüntülü", "Şaşkın"};  // Türkçe Textler
 ...
 { 
   if(ImageCount == images.Length-1) {
         SceneManager.LoadScene("DuygularQuiz");
      }
