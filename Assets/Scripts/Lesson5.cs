...
public class Lesson5 : MonoBehaviour
{
  ...
  [SerializeField]
    private GameObject LessonEnAudioButton;
     ...
     public string[] Entext = { "Bear","Birth","Cat", "Elephant", "Leon", "Doge", "Horse", "Tiger", "Fish", "Giraffe"}; // ingilizce Textler
     public string[] Trtext = {"Ayı","Kuş","Kedi","Fil", "Aslan", "Köpek", "At", "Kaplan", "Balık", "Zürafa"};  // Türkçe Textler
 ...
 { 
  if(ImageCount == images.Length-1) {
         SceneManager.LoadScene("HayvanlarQuiz");
      }
