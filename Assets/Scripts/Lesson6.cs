...
public class Lesson6 : MonoBehaviour
{
  ...
  [SerializeField]
    private GameObject LessonEnAudioButton;
     ...
     public string[] Entext = { "Foot","Leg","Neck", "Nose", "Eye", "Chest", "Arm", "Ear", "Shoulder", "Face"}; // ingilizce Textler
     public string[] Trtext = {"Ayak","Bacak","Boyun","Burun", "Göz", "Göğüs", "Kol", "Kulak", "Omuz", "Yüz"};  // Türkçe Textler
 ...
 { 
  if(ImageCount == images.Length-1) {
        SceneManager.LoadScene("AnatomiQuiz");
      }
