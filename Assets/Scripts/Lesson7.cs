...
public class Lesson7 : MonoBehaviour
{
  ...
  [SerializeField]
    private GameObject LessonEnAudioButton;
     ...
     public string[] Entext = { "Wardrop","Carpet","Bookcaise", "Seat", "Lamb", "Table", "Curtain", "Chair", "Bed"}; // ingilizce Textler
     public string[] Trtext = {"Dolap","Halı","Kitaplık","Koltuk", "Lamba", "Masa", "Perde", "Sandalye", "Yatak"};  // Türkçe Textler
 ...
 { 
  if(ImageCount == images.Length-1) {
         SceneManager.LoadScene("MobilyaQuiz");
      }
