...
public class Lesson8 : MonoBehaviour
{
  ...
  [SerializeField]
    private GameObject LessonEnAudioButton;
     ...
     public string[] Entext = { "Car","bicycle","Ship", "Truck", "motorcycle", "bus", "tractor", "Train", "Plane"}; // ingilizce Textler
     public string[] Trtext = {"Araba","Bisiklet","Gemi","Kamyon", "Motor", "Otobüs", "Traktör", "Tren", "Uçak"};  // Türkçe Textler
