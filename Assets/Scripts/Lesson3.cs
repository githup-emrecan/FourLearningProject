...
public class Lesson3 : MonoBehaviour
{
  ...
  [SerializeField]
    private GameObject LessonEnAudioButton;
     ...
     public string[] Entext = { "Mother","Father","Sister", "Brother", "Uncle", "Aunt", "Cousen", "GrandFather", "GrandMother", "GrandChild"}; // ingilizce Textler
     public string[] Trtext = {"Anne","Baba","Kız kardeş","Erkek kardeş", "Amca", "Teyze-Hala", "Kuzen", "Dede", "Büyükanne", "Torun"};  // Türkçe Textler
 ...
 { 
   if(ImageCount == images.Length-1) {
         SceneManager.LoadScene("AileQuiz");
      }
